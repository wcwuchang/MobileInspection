...
final class DecodeHandler extends Handler {
    ...
    private final ERCodeScannerActivity activity;
    private final MultiFormatReader multiFormatReader;
    private int[] mPositionTab = new int[8];

    private int index = 0;
    private int x;
    private int y;
    private int[] idecodeinfo;
    private long start = 0;

    DecodeHandler(ERCodeScannerActivity activity,
