...
public class MultiImageSelectorFragment extends Fragment {
    ...
    public static final String EXTRA_HAS_SELECT_COUNT = "max_has_select_count";
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (mode == MODE_MULTI) {
            ...
            mintHasChosed=getArguments().getInt(EXTRA_HAS_SELECT_COUNT,0);
        ...
        if (image != null) {
            if (mode == MODE_MULTI) {
                if (resultList.contains(image.path)) {
                    ...
                    if (selectImageCount() == resultList.size()+mintHasChosed) {
