 ...
 */
public class HiddenTroublesAdapter extends BaseAdapter{

    private Context context;
    private List<HiddenType> data;

    public HiddenTroublesAdapter (Context context){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            holder=new Holder();
            convertView= LayoutInflater.from(context).inflate(R.layout.listview_hidden_trouble_list_item,null);
            holder.name=(TextView)convertView.findViewById(R.id.tv_yh_detail_name);
            holder.content=(TextView)convertView.findViewById(R.id.tv_yh_detail_size);
