 ...
 */
public class PlanHasdoFragment extends BaseFragment {

    private View view;
    private ListView mlvHasdo;
    private TextView mtvDonull;
    private PlanDetailActivity contractDetail;
    private PlanManage contractManager;
    ...
    public void init(Context context,PlanDetailActivity contractDetail){
    ...
    private void initData() {
        ...
        contractManager=contractDetail.getPlanManage();
        if(contractManager==null||contractManager.getPlanDetails().size()==0){
            mtvDonull.setVisibility(View.VISIBLE);
            barChart.setVisibility(View.GONE);
            return;
        }
        hiddens=contractManager.getPlanDetails();
