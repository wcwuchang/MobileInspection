 ...
 * 日常任务上报
 */
public class DeailyMaintenanceUploadActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        if(isTodo) {
            ...
            if(intent.hasExtra("hidden")){
                ArrayList<HiddenType> data=(ArrayList<HiddenType>)intent.getSerializableExtra("hidden");
                addAdapter.updata(data);
            }
        }
        ...
        mlvTroubleList.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view,final int position, long id) {
                AlertDialog.Builder tuichuDialog = new AlertDialog.Builder(DeailyMaintenanceUploadActivity.this)
                        .setMessage("删除此项？");
...
//                    map.put("dailyMaintenanceMain.act.comment", "维修上报");
//                    map.put("dailyMaintenanceMain.act.flag", "yes");
                    map.put("dailyMaintenanceReportDetailList[" + 0 + "].num", CheckUntil.checkEditext(medtStockNum.getText()));
...
//        }
    ...
    private void uploadSuccess(){
        Toast.makeText(this, "机动维修上报成功", Toast.LENGTH_SHORT).show();
        Intent intent=new Intent(this,DeailyListActivity.class);
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    for (int i = 0; i < task.getFujian().size(); i++) {
                        ImageItem ii = new ImageItem();
                        ii.setIsadd(false);
                        ii.setImagePath(FileUtil.saveIntenetImage(DeailyMaintenanceUploadActivity.this,task.getFujian().get(i)));
                        choseImage.add(ii);
