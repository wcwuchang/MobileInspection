...
import com.tianjin.MobileInspection.activity.todo_task.TodoReportApproveActivity;
 ...
 * 机动维修详情
 */
public class DeailyDetailActivity extends BaseActivity{
    ...
    private void initData() {
        ...
        modlue.getDeilayDetail(deilayTaskId);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.btn_commit:
                ...
                Intent intent3=new Intent("android.intent.action.MAINTENANCEUPLOADACTIVITY");
            ...
            tuichuDialog.setPositiveButton("下载",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            DownLoadImageTask task = new DownLoadImageTask(DeailyDetailActivity.this, handler, filename);
