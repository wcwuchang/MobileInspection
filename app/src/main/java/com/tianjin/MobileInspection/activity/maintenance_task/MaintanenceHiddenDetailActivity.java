 ...
 * 隐患详情
 */
public class MaintanenceHiddenDetailActivity extends BaseActivity{
    ...
    public void resultData(Message msg) {
        ...
        switch (msg.what){
            case InspectionModule.INT_GET_HIDDEN_TROUBLE_SUCCESS:
                ...
                showData();
                break;
            case ConfigModule.INT_GET_ROAD_FILED:
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    for (int i=0;i<path.size();i++){
                        ...
                        imageItem.setImagePath(FileUtil.saveIntenetImage(MaintanenceHiddenDetailActivity.this,path.get(i)));
...
//        List<HiddenSpinner> stock=MyApplication.DBM.gettHiddenSpinner().query("spid",detail.getStockId());
        if(name!=null) {
            KLog.d(name.get(0).getName());
//            if(stock!=null)
//            KLog.d(stock.get(0).getName());
